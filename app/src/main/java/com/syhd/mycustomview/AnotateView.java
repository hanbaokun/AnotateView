...
public class AnotateView extends View {
    ...
    private void show(Canvas canvas) {
        ...
        path.cubicTo(centerX + circleIn, centerY + 100, centerX + 100, centerY + circleIn, centerX + 100, centerY);
        path.moveTo(centerX + 100, centerY);
        path.cubicTo(centerX + 100, centerY - circleIn, centerX + circleIn, centerY - 100, centerX, centerY - 100);
        path.moveTo(centerX, centerY - 100);
        path.cubicTo(centerX - circleIn, centerY - 100, centerX - 100, centerY - circleIn, centerX - 100, centerY);
        path.moveTo(centerX - 100, centerY);
        path.cubicTo(centerX - 100, centerY + circleIn, centerX - circleIn, centerY + 100, centerX, centerY + 100);
        ...
        float line1SX = centerX - 40;
        float line1EX = centerX + 40;
        if(startx<10){
            line1SX =  centerX - 40 + startx;
            line1EX = centerX + 40 - startx;
        }else {
            line1SX =  centerX - 40 + (startx-ends*2);
            line1EX = centerX + 40 - (startx-ends*2);
        }
        float line1SY = centerY - 50;
        float line1EY = centerY - 50;
        canvas.drawLine(line1SX, line1SY, line1EX, line1EY, linePaint);


        float line2SX = centerX - 40;
        float line2EX = centerX + 40;
        if(startx<10){
            line2SX = centerX - 40 - startx;
            line2EX = centerX + 40 + startx;
        }else {
            line2SX = centerX - 40 - (startx-ends*2);
            line2EX = centerX + 40 + (startx-ends*2);
        }

        float line2SY = centerY;
        float line2EY = centerY;
        ...
        float line3SX = centerX + 40 ;
        float line3EX = centerX - 40 ;
        if(startx<10){
            line3SX =  centerX - 40 + startx;
            line3EX = centerX + 40 - startx;
        }else {
            line3SX =  centerX - 40 + (startx-ends*2);
            line3EX = centerX + 40 - (startx-ends*2);
        }
